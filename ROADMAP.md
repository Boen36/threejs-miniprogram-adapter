...
**最近更新：2026-08-13。** 第一阶段的自动化收敛已完成，第二阶段正在推进；平台信息、网络生命周期和多 Canvas Document 归属审计已完成。微信开发者工具与真机证据仍待补齐。
...
- `npm run check` 覆盖语法、141 个 Node 测试、TypeScript consumer、publint 和打包检查。
...
- [x] 为远程 GLB、本地 GLB、内嵌纹理 GLB 和上下文恢复增加集成测试。
